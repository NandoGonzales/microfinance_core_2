...
function getSummary($conn, $where = '', $params = [], $types = '')
{
    ...
    // Last balance (overall, not filtered)
...
try {
    switch ($action) {
        ...
        // =====================================================
        // LIST TRANSACTIONS (with enhanced filters)
        // =====================================================
        case 'list':
            ...
            // Get summary with same filters (excluding offset/limit)
        ...
        // =====================================================
        // EDIT & DELETE (keep your existing logic)
        // =====================================================
        case 'edit':
            // Your existing edit code here
            echo json_encode(['status' => 'error', 'msg' => 'Edit not implemented in monitoring view']);
            break;

        case 'delete':
            // Your existing delete code here
            echo json_encode(['status' => 'error', 'msg' => 'Delete not implemented in monitoring view']);
            break;
